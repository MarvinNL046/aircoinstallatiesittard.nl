...
export const metadata: Metadata = {
  title: 'StayCool Airco Sittard | #1 in Airconditioning ✓',
  description: 'Dé airco specialist van Sittard! Professionele airco installatie voor woning en bedrijf door StayCool Airco. ✓ Gratis offerte ✓ Erkend installateur ✓ Alle topmerken ✓ 5 jaar garantie. Bel: 046 202 1430',
  alternates: {
          ...
          <div className="container">
            ...
            <div className="text-center mt-8">
              <p className="text-lg text-muted-foreground">
                Ontdek hoe StayCool Airco uw ideale partner is voor airconditioning in Sittard en omgeving.
              </p>
              <p className="mt-4">
                <a 
