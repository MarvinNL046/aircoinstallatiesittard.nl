...
export function generateMetadata({ params }: Props): Metadata {
  ...
  const title = `${dienst.title} in ${cityName} | StayCool Airco`
  ...
  return {
    ...
    openGraph: {
      title,
      description,
      url: `https://aircoinstallatiesittard.nl/diensten/${params.slug}/${params.city}`,
      siteName: "StayCool Airco Sittard",
      locale: "nl_NL",
      type: "website",
    },
    alternates: {
      canonical: `https://aircoinstallatiesittard.nl/diensten/${params.slug}/${params.city}`,
    },
    keywords: [
